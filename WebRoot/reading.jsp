...
<%
	...
	String sql;
  	...
  	try {
  		...
  		if(rs.next()) {	
  			enable = Integer.parseInt(rs.getString("reading"));
  		}
          								...
          								<TD>
            								<DIV align=left>
            									<FONT face="Verdana, Arial, Helvetica, sans-serif" color=#ff6600 size=1>
            										<B>
            											<FONT size=2>Reading Files--Download the image attachments</FONT>
            										</B>
            									</FONT>
            								</DIV>
            							</TD>
                								...
                								<table width="434" border="0">
                  									<tr>
                    									<td width="95" align="center">
                    										<input id=button3 type=submit value=Start name=button3     onClick="document.form1.action='/FU_System/servlet/PraseMimeMessage';document.form1.submit();" style=" display:  
                    										<%
                    											if(enable==1){
                 											%>
                												none
                    									...
                    									<td width="329" style=" font-size:14px;color:red;" >
                    										<input id=button4 type=submit value=Stop name=button4 onClick="document.form1.action='/FU_System/servlet/StopReading';document.form1.submit();" style=" display:  
                    										<%
                    											if(enable==0){
                											%>
                												none
                											...
                											<%
                												if(enable==1){
                 											%>
                    											Reading Function has been started!
                      										<%	}	%>
                      									</td>
                  									</tr>
                								</table>    
                							</FORM>             
                							&nbsp;&nbsp;&nbsp;&nbsp;* Start/Stop Reading the image attachments from mail server.&nbsp;&nbsp;&nbsp;
          								...
          								<TD width="19%" height=4>
            								<DIV align=right>
            									<A onmouseover="MM_swapImage('Image32','','images/arrow_r.gif',1)" 
            										onmouseout=MM_swapImgRestore() href="content2.jsp"><FONT 
            										size=1><B>Support</B></FONT> <IMG height=36 src="images/arrow.gif" 
            										width=22 align=Middle border=0 name=Image32></A>
            								</DIV>
            							</TD>
            						</TR>
            					</TBODY>
