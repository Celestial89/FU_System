...
<% 
	...
	String sql;
  	sql = "select * from member_signature where member_id='"+uid+"'";
...
<HTML>
	...
	<BODY bgColor=#ffffff leftMargin=0 background=images/home_background.gif topMargin=0 
		...
		<TABLE cellSpacing=0 cellPadding=0 width=740 align=center border=0>
  			<TBODY>
  				<TR>
    				<TD colSpan=11><br><IMG height=23 alt="" src="images/top_bar.gif" width=740></TD>
    			</TR>
  				<TR>
			 									...
			 									%>
              									<TR>
                									<TD  style="font-size:14px;">
                										<%
                											String path = "servlet/ChangeImage?filename=" + n + "&type=0";
                										%>
														&nbsp;&nbsp;&nbsp;&nbsp;(<%=j%>)&nbsp;
            							...
            							<TABLE width=228>
              								<TBODY>
              									<TR vAlign=top height=100>
                									<TD>Name: <%=firstname %>&nbsp;&nbsp;<%=lastname %><BR>Email: <%=email %><BR></TD>
                								</TR>
