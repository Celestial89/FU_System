      				...
      				<div align="center">
       					<table width="100%" border="0" cellspacing="2" cellpadding="2">
          					<tr>
            					<td>
              						<div align="left">
              							<font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#FF6600">
              								<b><font size="2">Administration Interface</font></b>
              							</font>
              						</div>
            					</td>
          					</tr>
        				...
        				<tr> 
          					<td height="83" valign="top"> 
            					<table width="500" border="0">
              						<tr>
             							<td width="306" style=" text-align:center; color:#00C"> Adding Administrator </td>
              						</tr>
              						<tr>
              							<td>
              								<center>
              								<form name="form1" method="post" action="/FU_System/servlet/AddAdmin">
                							 	<label for="username">UserName:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  								<input type="text" name="username" id="username">
               									<br>
                								<input type="submit" name="addbtn" id="addbtn" value="Submit">
                							</form>
                							</center>
                						</td>    						
              						</tr>
              						<tr>
                						<td style=" text-align:center; color:#00C">Administrator Password Modification</td>
                						<td>&nbsp;</td>
              						</tr> 	
             						<tr>
                						<td>
                							<center>
                							<form name="form2" method="post" onSubmit="return form2_onsubmit();" action="/FU_System/servlet/AdminPwdModify">
