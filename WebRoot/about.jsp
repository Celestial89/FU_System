 			...
 			<TR> 
      				...
      				<div align="center">
        				<table width="100%" border="0" cellspacing="2" cellpadding="2">
         					<tr>
            					<td>
              						<div align="left">
              							<font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#FF6600"><b>
              							<font size="2">About Us</font></b></font>
              						</div>
            					</td>
          					</tr>
        				</table>
  			...
  			<TR> 
    			<TD background="images/line1.gif" height="109"> 
    				<IMG SRC="images/line1.gif" WIDTH=2 HEIGHT=238 ALT="">
    			</TD>
   				<TD COLSPAN=7 valign="top" height="109"> 
      				<table width="100%" border="0" cellspacing="2" cellpadding="2">
        				<tr> 
          					<td valign="top"> 
            					<p><font size="1" face="Verdana, Arial, Helvetica, sans-serif">The project is designed by </font>Peter Mc Laughlin, Lin Nan and Ren Wei.</p>
            					<p>&nbsp;</p>
            				</td>
       					</tr>
      				</table>
    			...
    			<TD background="images/line3.gif" height="109"> 
    				<IMG SRC="images/line3.gif" WIDTH=2 HEIGHT=238 ALT="">
    			</TD>
  			</TR>
  			<TR> 
        				...
        				<tr> 
          					...
          					<td width="19%" height="4"> 
            					<div align="right"><a href="content2.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image32','','images/arrow_r.gif',1)"><font size="1"><b>Support</b></font> 
              					<img name="Image32" border="0" src="images/arrow.gif" width="22" height="36" align="middle"></a></div>
          					</td>
        				</tr>
      				</table>
    			</TD>
